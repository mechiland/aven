# Aven round 03 native verification handoff

Status: **waiting for root to release Aven UI**. No Aven UI actions have been
performed by verification during integration or capture.
...
Prepare a fresh `Documents/Aven operation check 20260915-round03` fixture using
...
UI, recording input and inspecting new round-03 captures:
...
- Round-03 video preview should show its poster while paused; Space should start
